...
export class AppService {
  ...
  getOrgServiceById(id : string){
    const orgServices = this.getOrgServices();
    return orgServices.find(service => service.id === id);
  }
  ...
  getOrgSolutions(){
    return [
      ...
      },
      {
        ...
        "servicesupport" : ["Data Center Solutions and Colocation Services",
      ...
      },
      {
        ...
        "servicesupport" : ["Integration Support",
      ...
      },
      {
        ...
        "servicesupport" : ["Network Security Solutions",
      ...
      },
      {
        ...
        "servicesupport" : ["Software Licensing and Integration",
      ...
      },
      {
        ...
        "servicesupport" : ["IT Infrastructure Optimization",
        "Cloud Solutions",
        "Consultation and Advisory Services"],
        "imageUrl" : "ispImage"
      },
      {
        ...
        "servicesupport" : ["Network Installation and Configuration",
  ...
  getOrgSolutionById(id : string){
    const orgSolutions = this.getOrgSolutions();
    return orgSolutions.find(solution => solution.id === id);
  }
  ...
  getAboutMainContent(){
    return [
      { 
        ...
        "imageUrl" : "/assets/images/aboutus1.jpg"
      }
  ...
  getNews(){
    return [
      { 
        ...
        "linkUrl" : "https://edition.cnn.com/2024/04/21/tech/microsoft-ai-tool-animates-faces/index.html"
      }
    ];
  }
